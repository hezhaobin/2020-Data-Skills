...
These functions come from the base R package but can work magically on many extended data classes. However, I advoicate for the switch to the tidyverse standard, which are easier to write and read.
